...
SELECT 
    ...
    b.end_date
FROM users u
FULL OUTER JOIN bookings b ON u.user_id = b.user_id ORDER BY u.user_id, b.booking_id;
...
SELECT 
    ...
    b.end_date
FROM users u
RIGHT JOIN bookings b ON u.user_id = b.user_id ORDER BY u.user_id, b.booking_id;
